            ...
            {students.length ? (
              students.map((s, index) => (
                <tr key={s.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-2 px-4 text-center">{s.parent_name}</td>
                  <td className="py-2 px-4 text-center">{s.parent_phone}</td>
                  <td className="py-2 px-4 text-center">{s.enrolled_class}</td>
